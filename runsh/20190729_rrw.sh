...
echo "2019.7.16 " >> drunkardmob.statistics
...
do
    ...
    do
        ...
        free -m
        java -Xmx40960m -cp target/graphchi-java-0.2.2-jar-with-dependencies.jar edu.cmu.graphchi.apps.randomwalks.RawRandomWalks   --graph=../../raid0_defghij/Friendster/out.friendster-reorder --nshards=10 --N=68349467 --R=$R --L=10 --s=13
    done
done
...
do
    ...
    do
        ...
        sync; echo 1 > /proc/sys/vm/drop_caches
        free -m
        java -Xmx40960m -cp target/graphchi-java-0.2.2-jar-with-dependencies.jar edu.cmu.graphchi.apps.randomwalks.RawRandomWalks   --graph=../../raid0_defghij/Friendster/out.friendster-reorder --nshards=10 --N=68349467 --R=100000 --L=$L --s=13
    done
done
